...
const ProductJual = ({ initialProducts }) => {
  ...
  const filteredProducts = initialProducts
    .filter((product) => {
      ...
      return (
        ...
        JSON.parse(product.market).includes("Di Jual")
      );
    })
    .filter((product) => product.user_id === "1");
  /// Add this condition to filter by user_id
                    ...
                    <div className="p-4 bg-white border rounded shadow-lg">
                      ...
                      <div className="mt-4">
                        <div className="flex mb-4 text-sm">
                          <div className="px-2 text-white rounded bg-bg"></div>
                        </div>
...
export async function getServerSideProps({ params }) {
  ...
  try {
    ...
    return {
      props: {
        initialProducts, // Ganti nama variabel sesuai kebutuhan
      },
    };
  } catch (error) {
