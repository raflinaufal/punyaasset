  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setProducts(apiData.products.slice(0, 5));
        setLoading(false);
      } catch (error) {
  ...
  return (
    <div className="pb-12">
      <div className="mx-auto containers">
        <div className="">
          <div className="flex items-center justify-between px-4 mb-4 text-2xl">
            <div className="text-xl font-medium mt-9 desktop:mt-5 mobile:text-lg">
              Property Terbaru
            </div>
                      ...
                      <div className="p-4 bg-white border rounded shadow-lg">
                        ...
                        <div className="flex mt-2 text-sm">
                          <div className="flex space-x-5 overflow-hidden">
                            ...
                            <p className="flex items-center overflow-hidden font-medium truncate text-black/80">
